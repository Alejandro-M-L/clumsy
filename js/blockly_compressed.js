...
Blockly.Options = function (a) {
    ...
    var t = "./media/"; // Se cambia la ruta para adquirir los archivos en media locales --> Para uso en Web Server // Local // Isaac
...
Blockly.Trashcan.prototype.animateLid_ = function () {
    ...
    this.svgGroup_.style.opacity = .8 + .8 * this.lidOpen_;
...
Blockly.WorkspaceSvg.prototype.createDom = function (a) {
    ...
    //a && this.grid_ && (this.svgBackground_.style.fill = "url(#" + this.grid_.getPatternId() + ")"));            "url('./images/png/1.jpg')"));
...
Blockly.Flyout.prototype.updateDisplay_ = function () {
    ...
    this.svgGroup_.style.display = a ? "block" : "none";////////////////: "none"
...
//Blockly.Generator.prototype.INDENT = " ";   Quite un espacio por que me generaba mas de un espacio
//".blocklyTreeRow... "background: white;" - Cambiar el color de fondo de la barra principal de elementos y categorias de bloques
// ".blocklyTreeRow:not(.blocklyTreeSelected):hover {", "background-color: white;", "}", - Cambiar el color de fondo del selector de la etiqueta  
// ".blocklyFlyoutBackground {", "fill: #00cad4;", "fill-opacity: .4;", "}", - Cambiar el color de background del toolbox donde estan los bloques
//".blocklyTreeRow {", "height: 47px;", "line-height: 47px;" margen de arriba y abajo ,,,,,,,,,"
//".blocklyTreeLabel {", "cursor: default;", "font-size: 16px;", "padding: 0 8px;" margen despues del texto
//".blocklyTreeSelected>.blocklyTreeIconNone {", "margin-left: 8px;","background-position: -48px 0px;", margen el el icono
//".blocklyZoom>image, .blocklyZoom>svg>image {", "opacity: .9;" opacidad en zoom
//this.svgGroup_.style.opacity = .8 + .8 * this.lidOpen_; opacidad del bote de basura
//".blocklyEditableText>rect {", "fill: #30FFAA", "fill-opacity: .6;", "}",  Cambio el color del rectangulo del bloque colour_picker, si le dejo la opacidad no se ve el color puro, por ello es necesario quitarsela para colores especiales no dentro de la gama de colores standar
Blockly.Css.CONTENT = [".blocklySvg {", "background-color: white;", "background-size: cover;", "background-repeat: no-repeat;", "outline: none;", "overflow: hidden;", "position: absolute;", "display: block;", "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 99999;", "}", ".injectionDiv {", "height: 100%;", "position: relative;", "overflow: hidden;", "touch-action: none", "}", ".blocklyNonSelectable {", "user-select: none;", "-moz-user-select: none;", "-ms-user-select: none;", "-webkit-user-select: none;", "}", ".blocklyWsDragSurface {", "display: none;",
...
"display: none;", "}", ".blocklyText {", "cursor: default;", "fill: #000;", "font-size: 11pt;", "}", ".blocklyNonEditableText>text {", "pointer-events: none;", "}", ".blocklyNonEditableText>rect,", ".blocklyEditableText>rect {", "fill: #fff;", "fill-opacity: .6;", "}", ".blocklyNonEditableText>text,", ".blocklyEditableText>text {", "fill: #000;", "}", ".blocklyEditableText:hover>rect {", "stroke: #fff;", "stroke-width: 2;", "}", ".blocklyBubbleText {", "fill: #000;", "}", ".blocklyFlyout {", "position: absolute;",
...
"height: 100%;", "margin: 0;", "outline: none;", "padding: 0 1px;", "width: 100%", "}", ".blocklyMainBackground {", "stroke-width: 1;", "stroke: #c6c6c6;", "}", ".blocklyMutatorBackground {", "fill: #fff;", "stroke: #ddd;", "stroke-width: 1;", "}", ".blocklyFlyoutBackground {", "fill: #fafafa;", "fill-opacity: 1;", "}", ".blocklyTransparentBackground {", "opacity: 0;", "}", ".blocklyMainWorkspaceScrollbar {", "z-index: 20;", "}", ".blocklyFlyoutScrollbar {", "z-index: 30;", "}", ".blocklyScrollbarHorizontal, .blocklyScrollbarVertical {",
"position: absolute;", "outline: none;", "}", ".blocklyScrollbarBackground {", "opacity: 0;", "}", ".blocklyScrollbarHandle {", "fill: #ccc;", "}", ".blocklyScrollbarBackground:hover+.blocklyScrollbarHandle,", ".blocklyScrollbarHandle:hover {", "fill: #bbb;", "}", ".blocklyZoom>image, .blocklyZoom>svg>image {", "opacity: .9;", "}", ".blocklyZoom>image:hover, .blocklyZoom>svg>image:hover {", "opacity: .6;", "}", ".blocklyZoom>image:active, .blocklyZoom>svg>image:active {", "opacity: .8;", "}", ".blocklyFlyout .blocklyScrollbarHandle {",
...
"-ms-user-select: none;", "-webkit-user-select: none;", "z-index: 70;", "-webkit-tap-highlight-color: transparent;", "}", ".blocklyTreeRoot {", "padding: 4px 0;", "}", ".blocklyTreeRoot:focus {", "outline: none;", "}", ".blocklyTreeRow {", "height: 47px;", "line-height: 47px;", "margin-bottom: 3px;", "padding-right: 8px;", "white-space: nowrap;","background: white;", "}", ".blocklyHorizontalTree {", "float: left;", "margin: 1px 5px 8px 0;", "}", ".blocklyHorizontalTreeRtl {", "float: right;", "margin: 1px 0 8px 5px;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {',
"margin-left: 8px;", "}", ".blocklyTreeRow:not(.blocklyTreeSelected):hover {", "background-color: #f5f5f5;", "}", ".blocklyTreeSeparator {", "border-bottom: solid #e5e5e5 1px;", "height: 0;", "margin: 5px 0;", "}", ".blocklyTreeSeparatorHorizontal {", "border-right: solid #e5e5e5 1px;", "width: 0;", "padding: 5px 0;", "margin: 0 5px;", "}", ".blocklyTreeIcon {", "height: 32px;", "vertical-align: middle;", "width: 32px;", "}", ".blocklyTreeIconClosedLtr {", "background-position: -32px -1px;",
"}", ".blocklyTreeIconClosedRtl {", "background-position: 0 -1px;", "}", ".blocklyTreeIconOpen {", "background-position: -16px -1px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedLtr {", "background-position: -32px -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedRtl {", "background-position: 0 -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconOpen {", "background-position: -16px -17px;", "}", ".blocklyTreeIconNone,", ".blocklyTreeSelected>.blocklyTreeIconNone {", "margin-left: 8px;","background-position: -48px 0px;",
"}", ".blocklyTreeLabel {", "cursor: default;", "font-size: 16px;", "padding: 0 8px;", "vertical-align: middle;", "}", ".blocklyToolboxDelete .blocklyTreeLabel {", 'cursor: url("<<<PATH>>>/handdelete.cur"), auto;', "}", ".blocklyTreeSelected .blocklyTreeLabel {", "color: #fff;", "}", ".blocklyColourTable {", "border-collapse: collapse;", "}", ".blocklyColourTable>tr>td {", "border: 1px solid #666;", "padding: 0;", "}", ".blocklyColourTable>tr>td>div {", "border: 1px solid #666;", "height: 13px;",
