...
//  return a + ";\n" //  Aqui se pone y se quita el dato al final de cada linea de comando, en este caso se mando el "; + \n" - Isaac
  return a + "" //  Par viXos es necesrio borrarla 
};
Blockly.JavaScript.quote_ = function (a) {
    a = a.replace(/\\/g, "\\\\").replace(/\n/g, "\\\n").replace(/'/g, "\\'");
 //  return "'" + a + "'" //  Aqui quitan las '' para que no salgan en el texto" -Isaac
	return " " + a + "" //  Par viXos es necesrio borrarlas " - Isaac
};
...
////////////////////////////////////////////////// C O L O U R S - F U N C T I O N S /////////////////////////////////////////////////
...
Blockly.JavaScript.colour_picker = function (a) {
    // return ["'" + a.getFieldValue("COLOUR") + "'", Blockly.JavaScript.ORDER_ATOMIC] 
	 return [a.getFieldValue("COLOUR"), Blockly.JavaScript.ORDER_ATOMIC] //Quito las '' para no salgan con el formato de color
};
...
//////////////////////////////////////////////////////////// V A R I A B L E - F U N C T I O N S ////////////////////////////////////////////
